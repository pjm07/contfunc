...
#     try:
#         digits.extend(list(map(int, open("pi_data/iteration" + str(iteration_idx) + ".txt").read().splitlines()))[1:])
#         iteration_idx += 1
#     except:
#         break
...
# for i in range(1, factor_max_power):
#     try:
...
# np.savetxt("pi_data_" + str(fit_limit) + "_2.txt", np.append(bins, hist), delimiter = ', ')
...
# while iteration_idx < 13:
#     print(iteration_idx)
    
#     try:
#         file = open("pi_data/iteration" + str(iteration_idx) + ".txt")
#         if iteration_idx == 1:
